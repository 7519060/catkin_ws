...
def main():
    ...
    # with open (filename, 'w') as f, open(filename2, 'w') as f2:
        ...
        # # #目標角度をプロット
        # ax1.axhline(y = 1.57, color = 'red', label = 'desired joint value')
        # ax2.axhline(y = -1.22, color = 'red', label = 'desired joint value')
        # ax3.axhline(y = 1.50, color = 'red', label = 'desired joint value')
        # ax4.axhline(y = -1.82, color = 'red', label = 'desired joint value')
        # ax5.axhline(y = -1.57, color = 'red', label = 'desired joint value')
